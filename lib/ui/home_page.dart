...
class _HomePageState extends State<HomePage> {
  ...
  static String API_KEY = 'fc659d3d686a4f7b8d2193744232406'; //aqui colocamos la apikey

  String location = 'London'; //Dejamos por defecto londond
  String weatherIcon = 'heavycloud.png';
  //Inicializamos variables del clima
  int temperature = 0;
  int windSpeed = 0;
  int humidity = 0;
  int cloud = 0;
  ...
  void fetchWeatherData(String searchText) async {
    try {
      ...
      setState(() {
        ...
        //obtenemos la  data del pronostico a dias posteriores
  ...
  //esta funcion nos devuelve los 2 primeros nombres de una ubicacion
